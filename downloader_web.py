...
for line in lines:
	if   "json" in line:
		os.system('wget http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + line[:-1] + " -O " + os.path.join(jsonDir, line[:-1]) )
		...
		os.system('wget http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + line[:-1]  + " -O " + os.path.join(jpgDir, line[:-1]) )
	elif "bmp" in line:
		os.system('wget http://spectrumcatcher.polarstarspace.com/veggie/results/mkuriki/' + line[:-1]  + " -O " + os.path.join(bmpDir, line[:-1]) )
