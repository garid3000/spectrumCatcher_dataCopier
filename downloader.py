...
for line in lines:
	if   "json" in line:
		os.system('wget http://192.168.11.4:8080/storage/emulated/0/Android/data/com.polarstarspace.veggiecamera/files/' + line[:-1] + " -O " + os.path.join(jsonDir, line[:-1]) )
		...
		os.system('wget http://192.168.11.4:8080/storage/emulated/0/Android/data/com.polarstarspace.veggiecamera/files/' + line[:-1]  + " -O " + os.path.join(jpgDir, line[:-1]) )
	elif "bmp" in line:
		os.system('wget http://192.168.11.4:8080/storage/emulated/0/Android/data/com.polarstarspace.veggiecamera/files/' + line[:-1]  + " -O " + os.path.join(bmpDir, line[:-1]) )
